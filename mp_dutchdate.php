...
function multipop_date_replace($text) {
	$days_english = array('Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Firday', 'Saturday', 'Sunday', 'Mar', 'May', 'Oct', 'January', 'February', 'March', 'May', 'June', 'July', 'October');
