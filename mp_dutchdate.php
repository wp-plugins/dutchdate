...
function multipop_date_replace($text) {
	$days_english = array('Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday', 'Mar', 'May', 'Oct', 'January', 'February', 'March', 'May', 'June', 'July', 'August', 'October', 'nd', 'th');
	$days_dutch = array('Ma', 'Di', 'Wo', 'Do', 'Vr', 'Za', 'Zo', 'Maandag', 'Dinsdag', 'Woensdag', 'Donderdag', 'Vrijdag', 'Zaterdag', 'Zondag', 'Mrt', 'Mei', 'Okt', 'Januari', 'Februari', 'Maart', 'Mei', 'Juni', 'Juli', 'Augustus', 'Oktober', '', '');
